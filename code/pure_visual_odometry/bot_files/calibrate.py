...
if __name__ == '__main__':
    ...
    parser.add_argument('--width',nargs="?", help='Width in pixels of the image',default=1080,type=int)
...
# parser.add_argument('--figure', help='saved visualization name', default=None)
    ...
    source = cv2.VideoCapture(gstreamer_pipeline(), cv2.CAP_GSTREAMER)
    ...
    print("width, height")
    print(source.get(cv2.CAP_PROP_FRAME_WIDTH))
    print(source.get(cv2.CAP_PROP_FRAME_HEIGHT))
